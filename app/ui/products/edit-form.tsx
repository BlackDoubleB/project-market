...
export default function EditCategoryForm({
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="rounded-md bg-gray-50 p-4 md:p-6 border-1">
        {/* Category Name */}
        <div className="mb-4">
          <label
            htmlFor="category_id"
          ...
          <div className="relative">
            ...
            <select
              ...
              focus:outline-none border-1 border-gray-300 focus:border-blue-200  focus:ring-blue-200 focus:ring-1 focus:shadow-md focus:shadow-blue-200/50 cursor-pointer"
            ...
            <div className="relative">
              ...
              <div className="mb-2">
                <img
                  ...
                  className="w-32 h-32 object-cover rounded-md border-1 border-gray-300"
                />
              </div>
              ...
              <input
                ...
                className="block w-full text-sm text-gray-900 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
          ...
          <div className="relative mt-2 rounded-md">
            <div className="relative">
              <input
                ...
                className="peer block w-full rounded-md py-2 pl-10 text-sm placeholder:text-gray-500 focus:outline-none border-1 border-gray-300 focus:border-blue-200  focus:ring-blue-200 focus:ring-1 focus:shadow-md focus:shadow-blue-200/50"
              />
              <Icon
      ...
      <div className="mt-6 flex justify-end gap-4">
        <Link
          ...
          className="flex h-10 items-center rounded-lg
           px-4 text-sm font-medium text-white transition-colors bg-red-600 hover:bg-red-500"
        >
          Cancel
        </Link>
        <Button
