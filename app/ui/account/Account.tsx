          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <div className="space-y-1">
                ...
                <p
                  id="name"
                  className="cursor-default lg:w-full px-3 py-2 border rounded-md shadow-sm text-gray-700 bg-gray-50 focus:ring-2 focus:ring-blue-500"
                >
                  {user.role_name}
                </p>
              </div>
              <div className="space-y-1">
                ...
                <p className="cursor-default lg:w-full  px-3 py-2 border rounded-md shadow-sm text-gray-700 bg-gray-50 focus:ring-2 focus:ring-blue-500">
