...
export function AlertDanger({ message }: { message: string }) {
  ...
  return (
    <div className="slide-left fixed top-4 right-5 z-50 w-96">
      <div
      ...
      >
        ...
        <button
          type="button"
          onClick={() => setVisible(false)} // Esto actualiza el estado visible a false
          className="ms-auto -mx-1.5 -my-1.5 bg-red-50 text-red-500 rounded-lg focus:ring-2 focus:ring-red-400 p-1.5 hover:bg-red-200 inline-flex items-center justify-center h-8 w-8 dark:bg-gray-800 dark:text-red-400 dark:hover:bg-gray-700 cursor-pointer"
          aria-label="Close"
        >
          <span className="sr-only">Dismiss</span>
          <svg
